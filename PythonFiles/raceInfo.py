...
def get_race_info(race_url):
    ...
    if race_info_json["index"] == "human":
        race_info = {"Speed": 0, "Size": 0, "Ability_Bonuses": 0, "Languages": 0, "Language_Options": 0,
                     "Traits": 0, "Starting_Proficiencies": 0}
    else:
        if "starting_proficiency_options" in race_info_json:
            race_info = {"Speed": 0, "Size": 0, "Ability_Bonuses": 0, "Languages": 0, "Traits": 0,
